...
import nfcReader.plugin.NfcVHandler;
...
public class NfcVPlugin extends CordovaPlugin {
    ...
    private static final String START_READING_MIFARE = "startReadingMifare";
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        } else if(action.equalsIgnoreCase(START_READING_MIFARE)){
            handler.startReadingMifare();
